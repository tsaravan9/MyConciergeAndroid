...
//    private List<Building> tempDeliveries = new ArrayList<>();
//    private ActivityLogAdapter.OnItemClickListener listener;
//
//    @NonNull
//    @Override
//    public BuildingAdapter.BuildingHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
//        View itemView = LayoutInflater.from(parent.getContext())
//                .inflate(R.layout.building_item, parent, false);
//        return new BuildingAdapter.BuildingHolder(itemView);
//    }
//
//    @Override
//    public void onBindViewHolder(@NonNull BuildingAdapter.BuildingHolder holder, int position) {
...
//    }
//
//    public void setOnItemClickListener(BuildingAdapter.OnItemClickListener listener) {
